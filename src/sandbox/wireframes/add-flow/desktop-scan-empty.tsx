/**
 * @screen add-flow/desktop-scan-empty
 * @shell DesktopShell with scrim on content only
 *
 * Desktop add word modal — Scan tab, empty state.
...
import { ScanEmptyContent } from "./_tab-contents";

export function AWDesktopScanEmpty() {
  return (
    <DesktopShell
      active="library"
